...
\begin{enumerate}
	...
	For image compression, this means representing the image with only a limited number of distinct colors.
	...
	The quantization scheme is not unlike that used by JPEG on the 8x8 blocks.
