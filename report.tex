...
This was done using built-in Mathematica functions.
...
\begin{figure}[p]
	\centering
	\includegraphics{resources/example/originalExample.png}
	\caption{An untransformed image.}
	\label{fig:originalExample}
\end{figure}
\begin{figure}[p]
    \centering
    \includegraphics{resources/example/losslessTransform.png}
    \caption{The result of the CDF 5/3 wavelet transform.}
    \label{fig:losslessTransform}
\end{figure}
\begin{figure}
    \centering
    \includegraphics{resources/example/lossyTransform.png}
...
and \ref{fig:lossyTransform} shows the result of a CDF 9/7 wavelet transform.
